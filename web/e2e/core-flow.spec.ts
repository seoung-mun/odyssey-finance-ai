...
test("authenticated dashboard shows the goal path", async ({ page }) => {
  ...
  await page.route("**/api/v1/dashboard", (route) => route.fulfill({ status: 200, contentType: "application/json", body: JSON.stringify({
    ...
    activePlan: { id: 3, status: "ACTIVE", infeasibleReason: null, snapshot: { resolvedSpendingFloor: { mode: "AUTO", effectiveMonthlyAmount: 820000 } }, explanation: { status: "FALLBACK", text: "계획 수치를 기준으로 선택해 주세요." } },
    selectedOption: { id: 7, recommendedMonthlySpending: 920000, requiredReductionRate: 0.31, simulationCoverage: 0.83, historicalFeasibilityRatio: 0.58, aggressiveWarning: false, floorApplied: true, percentileBands: [{ monthIndex: 1, p10: 8900000, p25: 9000000, p50: 9100000, p75: 9200000, p90: 9300000 }, { monthIndex: 28, p10: 27000000, p25: 29000000, p50: 31000000, p75: 33000000, p90: 35000000 }] },
